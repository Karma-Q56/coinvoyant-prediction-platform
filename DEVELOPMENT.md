...
```bash
git remote add encore encore://coinvoyant-prediction-platform-4ioi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/coinvoyant-prediction-platform-4ioi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/coinvoyant-prediction-platform-4ioi/settings/integrations/github)
