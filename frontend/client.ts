...
import { getPendingResolutions as api_admin_get_pending_resolutions_getPendingResolutions } from "~backend/admin/get_pending_resolutions";
import { getResolutionMetrics as api_admin_get_resolution_metrics_getResolutionMetrics } from "~backend/admin/get_resolution_metrics";
...
export namespace admin {
    ...
    export class ServiceClient {
        ...
        constructor(baseClient: BaseClient) {
            ...
            this.getPendingResolutions = this.getPendingResolutions.bind(this)
            this.getResolutionMetrics = this.getResolutionMetrics.bind(this)
        ...
        public async getPendingResolutions(): Promise<ResponseType<typeof api_admin_get_pending_resolutions_getPendingResolutions>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/admin/pending-resolutions`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_admin_get_pending_resolutions_getPendingResolutions>
        }

        public async getResolutionMetrics(): Promise<ResponseType<typeof api_admin_get_resolution_metrics_getResolutionMetrics>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/admin/resolution-metrics`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_admin_get_resolution_metrics_getResolutionMetrics>
        }
